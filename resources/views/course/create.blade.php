        ...
        <div class="card border-0 shadow-sm mb-5">
            ...
            <div class="card-body row g-4">
                <div class="col-md-8">
                    ...
                    <input type="text" name="title" class="form-control shadow-sm" placeholder="Enter course title" required>
                    @error('title')
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="course_price" class="form-control shadow-sm" placeholder="Enter course price">
                </div>

                <div class="col-md-12">
                    <label class="form-label fw-semibold">Course Summary</label>
                    <textarea name="summary" id="summary" class="form-control shadow-sm" rows="6" placeholder="Write an overview of this course..."></textarea>
                </div>
            </div>
        </div>
    ...
    contentDiv.innerHTML = `
        ...
        <div class="p-3 border rounded-bottom content-body">
            ...
            <div class="mb-2">
                ...
                <select name="modules[${moduleIndex}][contents][${contentCount}][video_type]" class="form-select shadow-sm">
